...
int main(int argc, char* argv[])
{
  ...
  //___________________________________________________________________________________________________________________
   ...
   for(k=0; k<num_images; k++){  // iterate through the #-frames = num_image
	
      background(153,255,153,width,height,r,g,b); 
	
	
	 //Start
     if (k < 30){ireturn=number1(120, 320, 0.0,r,g,b,width,height);}
     if (k>=30 && k < 60){ireturn=number2(320, 280, 0.0,r,g,b,width,height);}
     if (k>=60&& k < 90){number3(480, 330, 0.0,r,g,b,width, height);}
     if(k>=90 && k < 120){
          ireturn=rectangle(1,320,960,320,0.0,(unsigned char)255,(unsigned char)255,(unsigned char)255,r,g,b,960,640);
		  ireturn=ellipse(100 ,100, 100, 100, 0, (unsigned char)253,(unsigned char)200,(unsigned char)20,r,g,b,960,640);
		  ireturn=girl_tinman(400,620,70, 60.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,r,g,b,width,height);
          ireturn=girl_tinman(300,510,70, 60.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,r,g,b,width,height);
          ireturn=girl_tinman(150,400,70, 60.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,r,g,b,width,height);
          ireturn=guy_tinman(500,620,70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height);
          ireturn=guy_tinman(600,510,70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height);
          ireturn=guy_tinman(750,400,70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height);
		  if(k%5==0){
		  ireturn=girl_tinman(400,620-20,70, 60.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,r,g,b,width,height);
          ireturn=girl_tinman(300,510-20,70, 60.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,r,g,b,width,height);
          ireturn=girl_tinman(150,400-20,70, 60.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,r,g,b,width,height);
		  }
		  else{
		  ireturn=girl_tinman(400,620-10,70, 60.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,r,g,b,width,height);
          ireturn=girl_tinman(300,510-10,70, 60.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,r,g,b,width,height);
          ireturn=girl_tinman(150,400-10,70, 60.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,r,g,b,width,height);
	 ...
	 if (k>=120 && k < 240){
          ...
          ireturn=guy_tinman(750,400,70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height);
		  if (k%5==0){
		  ireturn=guy_tinman(500,620-20,70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height);
          ireturn=guy_tinman(600,510-20,70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height);
          ireturn=guy_tinman(750,400-20,70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height);
			  
		  }
		  else{
		  ireturn=guy_tinman(500,620-10,70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height);
          ireturn=guy_tinman(600,510-10,70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height);
          ireturn=guy_tinman(750,400-10,70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height);
	 ...
	 /*if(k>=480 && k < 600){
		 ireturn=rectangle(1,320,960,320,0.0,(unsigned char)255,(unsigned char)255,(unsigned char)255,r,g,b,960,640);
		 ireturn=ellipse(100, 100, 100, 100, 0, (unsigned char)253,(unsigned char)200,(unsigned char)20,r,g,b,960,640);
		 /* ireturn=girl_tinman(530,height/2-70-(k-400),70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          //yellow down guy
          ireturn=girl_tinman(530,height/2+80,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          //yellow top guy
          ireturn=girl_tinman(330,height/2-140,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          //yellow goal keep
          ireturn=girl_tinman(100,height/2-50,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          //red starter
          ireturn=guy_tinman(500,height/2-120,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          //red down
          ireturn=guy_tinman(400,height/2+90,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          //red top
          ireturn=guy_tinman(600,height/2-140,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          // red Goal keep
          ireturn=guy_tinman(860,height/2-50,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);

          ireturn=ball(width/2+100-(k-400),height/2-100,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)0,r,g,b,width,height);
	 ...
	 if(k>=600 && k < 720){
		 /* ireturn=girl_tinman(530,height/2-70-(k-400),70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          ...
          ireturn=girl_tinman(100,height/2-50,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          //red starter
          ireturn=guy_tinman(500,height/2-120-(k-450),70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          //red down
          ireturn=guy_tinman(400,height/2+90,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          //red top
          ireturn=guy_tinman(600,height/2-140,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          // red Goal keep
          ireturn=guy_tinman(860,height/2-50,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          ireturn=ball(width/2+50,height/2-100-(k-500),70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)0,r,g,b,width,height);
		 
	 }
	 if (k>= 720 && k < 840){
		 /* if(k<600){
          ireturn=girl_tinman(530+(k-500),height/2-170,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          }else if(k<700){
          ireturn=girl_tinman(630,height/2-170,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          }else if(k<800){
          ireturn=girl_tinman(630,height/2-170+(k-700),70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          }else{
          ireturn=girl_tinman(630,height/2-70,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          }
          //yellow down guy
          ireturn=girl_tinman(530,height/2+80,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          //yellow top guy
          ...
          //red starter
          if(k<600){
          ireturn=guy_tinman(500,height/2-170+(k-500),70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          }else{
          ireturn=guy_tinman(500,height/2-30,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          }
          //red down
          ireturn=guy_tinman(400,height/2+90,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          //red top
          if(k>700){
          ireturn=guy_tinman(600+(k-700),height/2-140,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          }else{
          ireturn=guy_tinman(600,height/2-120,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);

          }
          // red Goal keep

          if(k<700){
          ireturn=guy_tinman(860,height/2-50-(k-700),70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          }if(k>700 && k<= 800){
          ireturn=guy_tinman(860,height/2-100,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          }if(k>800 && k<= 900){
          ireturn=guy_tinman(860,height/2-100+(k-800),70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          }if(k>900){
          ireturn=guy_tinman(860,height/2-50,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          }
          if(k<600){
          ireturn=ball(width/2+50,height/2-50+(k-500),70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)0,r,g,b,width,height);
          }else if(k<700){
          ireturn=ball(width/2+50+(k-600),height/2-50-(k-650),70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)0,r,g,b,width,height);
          }else if(k<800){
          ireturn=ball(width/2+150,height/2-100+(k-700),70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)0,r,g,b,width,height);
          }else{
          ireturn=ball(width/2+130+(7*(k-800)),height/2,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)0,r,g,b,width,height);
          }
	 }
	 if(k>=840 && k < 960){
		/* //red starter
          ...
          ireturn=guy_tinman(400,height/2+90,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          //red top
          ireturn=guy_tinman(860,height/2-120,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          // red Goal keep
          ireturn=guy_tinman(860,height/2-50,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          //yellow starter
          ireturn=girl_tinman(630-2*(k-900),height/2-70,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          //yellow down guy
          ireturn=girl_tinman(530-2*(k-900),height/2+80,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          //yellow top guy
          ireturn=girl_tinman(330-(k-900),height/2-140,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          //yellow goal keep
          ireturn=girl_tinman(100,height/2-50,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
	 }
	 if(k>=960 && k < 1080){
		//red starter
          ...
          ireturn=guy_tinman(860,height/2-50,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          //yellow starter
          ireturn=girl_tinman(230-(k-1100),height/2-70,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          //yellow down guy
          ireturn=girl_tinman(130,height/2+80-(k-1100),70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          //yellow top guy
          ireturn=girl_tinman(130,height/2-140,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height);
          //yellow goal keep
          ireturn=girl_tinman(100,height/2-50,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)255,r,g,b,width,height); 
	 }
	 if(k >=1080 && k < 1200 ){
		   ...
		   int image_width, int image_height)
{
  int ireturn;
     ...
     // face
	 ireturn=ellipse(upper_x-6,upper_y+33,16,20,0.0,red,green,blue,
	 ...
	 ireturn=triangle(upper_x-2,upper_y+25,5,4,2,0.0,(unsigned char)255,(unsigned char)255,(unsigned char)255,
	         r,g,b,image_width,image_height);
     // hat
	 ireturn=triangle(upper_x-9,upper_y+15,21,11,11,0.0,(unsigned char)0,(unsigned char)255,(unsigned char)0,
	         r,g,b,image_width,image_height);
     // neck
     ireturn=rectangle(upper_x-2,upper_y+40,7,7,0.0,red,green,blue,
	         r,g,b,image_width,image_height);
     // body
     ireturn=triangle(upper_x+32,upper_y+73,45,45,45,495.0,(unsigned char)0,(unsigned char)255,(unsigned char)0,
	         r,g,b,image_width,image_height);
	 //left hand
	 ireturn=rectangle(upper_x-5,upper_y+46,5,18,90.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,
	         r,g,b,image_width,image_height);
			 
	 //right hand
	 ireturn=rectangle(upper_x+23,upper_y+46,5,18,90.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,
	         r,g,b,image_width,image_height);
	 // mouth
     ireturn=rectangle(upper_x-3,upper_y+29,7,1,0.0,(unsigned char)255,(unsigned char)255,(unsigned char)255,
	         r,g,b,image_width,image_height);
	//left leg
	ireturn=rectangle(upper_x-7,upper_y+90,5,18,0.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,
	         r,g,b,image_width,image_height);
	//right leg
	ireturn=rectangle(upper_x+5,upper_y+90,5,18,0.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,
	         r,g,b,image_width,image_height);
		   ...
		   int image_width, int image_height)
{
  int ireturn;
     ...
     ireturn=rectangle(upper_x-2,upper_y+40,7,7,0.0,red,green,blue,
	         r,g,b,image_width,image_height);
     // body
     ireturn=rectangle(upper_x-8,upper_y+80,20,40,0.0,(unsigned char)150,(unsigned char)177,(unsigned char)210,
	         r,g,b,image_width,image_height);
	 //left hand
	 ireturn=rectangle(upper_x-10,upper_y+47,5,18,90.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,
	         r,g,b,image_width,image_height);
			 
	 //right hand
	 ireturn=rectangle(upper_x+29,upper_y+47,5,18,90.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,
	         r,g,b,image_width,image_height);
	 // mouth
     ireturn=rectangle(upper_x-3,upper_y+29,7,2,0.0,(unsigned char)255,(unsigned char)255,(unsigned char)255,
	         r,g,b,image_width,image_height);
	//left leg
	ireturn=rectangle(upper_x-7,upper_y+97,5,18,0.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,
	         r,g,b,image_width,image_height);
	//right leg
	ireturn=rectangle(upper_x+5,upper_y+97,5,18,0.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,
	         r,g,b,image_width,image_height);
...
int field(int upper_x, int upper_y, int r_height, float angle_deg,
		   unsigned char red, unsigned char green, unsigned char blue,
		   unsigned char * r, unsigned char * g, unsigned char * b,
		   int image_width, int image_height)
{
