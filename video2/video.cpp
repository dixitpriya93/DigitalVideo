...
int main(int argc, char* argv[])
{
  ...
  //___________________________________________________________________________________________________________________
   ...
   for(k=0; k<num_images; k++){  // iterate through the #-frames = num_image
     ...
     if(k>=90 && k < 120){
	 ireturn=ellipse(150, 150,100,100, 0.0, (unsigned char)253,(unsigned char)184,(unsigned char)19,r,g,b,960,320);
	 ireturn=girl_tinman(428,height/2-71,70, 60.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,r,g,b,width,height); //striker 
	 ireturn=girl_tinman(328,height/2+79,70, 60.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,r,g,b,width,height); //top mid fielder
     ireturn=girl_tinman(328,height/2-139,70, 60.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,r,g,b,width,height);//down mid fielder
	 ireturn=girl_tinman(98,height/2-48,70, 60.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,r,g,b,width,height); // goal keeper
     ireturn=guy_tinman(498,height/2-48,70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height); //striker 
	 ireturn=guy_tinman(598,height/2+82,70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height); //top mid fielder
     ireturn=guy_tinman(598,height/2-139,70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height);//down mid fielder
     ireturn=guy_tinman(858,height/2-48,70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height);  // goal keeper
	 ireturn=soccer(width/2,height/2,70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)0,r,g,b,width,height); 
     }
	 if (k>=120 && k < 200){
		  ireturn=ellipse(150, 150,100,100, 0.0, (unsigned char)253,(unsigned char)184,(unsigned char)19,r,g,b,960,320);
		  ireturn=girl_tinman(428,height/2-71,70, 60.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,r,g,b,width,height);
          ireturn=girl_tinman(328,height/2+79,70, 60.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,r,g,b,width,height);
          ireturn=girl_tinman(328,height/2-139,70, 60.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,r,g,b,width,height);
          ireturn=girl_tinman(98,height/2-48,70, 60.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,r,g,b,width,height);
          ireturn=guy_tinman(498,height/2-48,70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height);
          ireturn=guy_tinman(598,height/2+82,70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height);
          ireturn=guy_tinman(598,height/2-139,70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height);
          ireturn=guy_tinman(858,height/2-48,70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height);
          ireturn=soccer(width/2+(k-99),height/2+(k-99),70, 60.0,(unsigned char)0,(unsigned char)0,(unsigned char)0,r,g,b,width,height);
	 }
	 if(k>=200 && k < 400){
		 ireturn=ellipse(150, 150,100,100, 0.0, (unsigned char)253,(unsigned char)184,(unsigned char)19,r,g,b,960,320);

		if(k>300){
          ireturn=girl_tinman(428+(k-300),height/2-71,70, 60.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,r,g,b,width,height);
          }
          if(k<=300){
          ireturn=girl_tinman(428,height/2-48,70, 60.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,r,g,b,width,height);
          }
		
         ireturn=girl_tinman(328+(k-200),height/2+82,70, 60.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,r,g,b,width,height);
          ireturn=girl_tinman(328,height/2-139,70, 60.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,r,g,b,width,height);
          ireturn=girl_tinman(98,height/2-48,70, 60.0,(unsigned char)228,(unsigned char)153,(unsigned char)105,r,g,b,width,height);
		  
          if(k<270){
          ireturn=guy_tinman(498,height/2-(50-200+k),70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height);
          }
		  else{
          ireturn=guy_tinman(498,height/2-120,70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height);
          }
          ireturn=guy_tinman(598-(k-200),height/2+90,70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height);
          ireturn=guy_tinman(598,height/2-139,70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height);
          ireturn=guy_tinman(858,height/2-48,70, 60.0,(unsigned char)172,(unsigned char)112,(unsigned char)61,r,g,b,width,height);
